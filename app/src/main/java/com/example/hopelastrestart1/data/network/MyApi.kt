...
suspend fun updateHKActivity(
    ...
    suspend fun addOrganization(
        ...
        @Field("organization_email") orgEmail: String,
        @Field("organization_location") orgLocation: String,
        @Field("username") orgUser: String,
...
suspend fun userOrganizationProjects(
    ...
    suspend fun addProject(
        ...
        @Field("organization_name") orgName: String,
        @Field("project_type") projType: String,
        @Field("project_location") projLocation: String,
        @Field("project_description") projDescription: String,
        @Field("username") projUser: String,
        ) : Response<ProjectResponse>
// plan urls
//Projects urls
@FormUrlEncoded
