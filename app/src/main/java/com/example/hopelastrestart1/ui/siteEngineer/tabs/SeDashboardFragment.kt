...
class SeDashboardFragment : Fragment(), KodeinAware {
    override val kodein by kodein()
    private val factory: TaskViewModelFactory by instance()
    private lateinit var viewModel: TaskViewModel
    private lateinit var binding: FragmentSeDashboardBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val rootView = inflater.inflate(R.layout.fragment_se_dashboard, container, false)
        var binding: FragmentSeDashboardBinding? = DataBindingUtil.inflate(
            inflater, R.layout.fragment_se_dashboard, container, false
        )
