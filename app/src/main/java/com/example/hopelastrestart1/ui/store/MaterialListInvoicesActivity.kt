...
import com.example.hopelastrestart1.databinding.ActivityMaterialListInvoicesBinding
...
class MaterialListInvoicesActivity : BaseActivity(), MyMaterialInvoiceClickListner {
    lateinit var binding: ActivityMaterialListInvoicesBinding
    private lateinit var viewModel: StoreViewModel
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        var contentFrameLayout = findViewById(R.id.container) as FrameLayout
        binding = ActivityMaterialListInvoicesBinding.inflate(layoutInflater)
        contentFrameLayout.addView(binding!!.root)
        //drawerLayout.addView(contentView, 0)
        title = "Material Invocies"
        ...
        getMaterialInvoices(postdata)
        binding.fab.setOnClickListener(View.OnClickListener {
            val intent = Intent(this, AddMaterialInvoiceActivity::class.java)
    ...
    private fun getMaterialInvoices(getAllMachineInvoices: GetAllMachineInvoices) {
        viewModel.getMaterialInvoices(getAllMachineInvoices).observe(this, Observer {
            it.let { resource ->
...
//adapter.notifyDataSetChanged()
    ...
    override fun onCellClickListener(invoice: Invoices) {
        val intent = Intent(this, ViewMaterialInvoiceActivity::class.java)
