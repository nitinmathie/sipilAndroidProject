...
import com.example.hopelastrestart1.adapter.CellClickListenerMatDisp
import com.example.hopelastrestart1.adapter.InvoicesAdapter
import com.example.hopelastrestart1.adapter.MaterialDispatchedAdapter
...
class MaterialDispFragment : Fragment(), CellClickListenerMatDisp {
    ...
    private fun fetchMaterialDispatchedByMe(fmdispatchedByMe: GetMacAndMatDispbyMe) {
        viewModel.fetchMaterialDispatchedByMe(fmdispatchedByMe)
    ...
    override fun CellClickListenerMatDisp(
