...
class AdminDPRsAdapter(
    val reports: MutableList<Units>,
    private val cellClickListener: CellClickListenerAdminDPRsReports,
    val loginType: String,
) : RecyclerView.Adapter<AdminDPRsAdapter.RowViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int)
            : AdminDPRsAdapter.RowViewHolder {
 ...
 */
    ...
    interface CellClickListenerAdminDPRsReports {
