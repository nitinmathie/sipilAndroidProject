...
class AssignedToMeRvAdapter(
    val allActs: List<AssignedToMeEntity>,
    val mctx: Context,
    val cellClickListener: CellClickListener_AssignedToMe,
    val username: String,
    val organization_name: String,
    val project_name: String,

):RecyclerView.Adapter<AssignedToMeRvAdapter.ViewHolder>(){
...
interface  CellClickListener_AssignedToMe {
    // abstract val activity: Context?
    fun onCellClickListener(
        activity: AssignedToMeEntity, username: String,
