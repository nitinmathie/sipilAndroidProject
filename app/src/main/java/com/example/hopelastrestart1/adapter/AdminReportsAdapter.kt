...
class AdminReportsAdapter(
    ...
    private val cellClickListener: CellClickListenerAdminReports,
    val loginType: String,
 ) : RecyclerView.Adapter<AdminReportsAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int)
            : AdminReportsAdapter.ViewHolder {
        val v: View = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_admin_reports, parent, false)
        return ViewHolder(v)
    }
...
interface CellClickListenerAdminReports {
